...
execute unless score EnableChestSearch BSConfig matches 0..2 run scoreboard players set EnableChestSearch BSConfig 0
execute unless score MaxStackSize BSConfig matches 1..127 run scoreboard players set MaxStackSize BSConfig 64
execute unless score Optimize BSConfig matches 0..1 run scoreboard players set Optimize BSConfig 0
